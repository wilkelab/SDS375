...
.center[
```{r freq-waffle2, out.width = "90%", fig.width = 10, fig.asp = 0.45, echo = FALSE, dev = "svg"}
...
.center[
```{r sampling-schematic1, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 3/4, dev = "svg"}
...
.center[
```{r sampling-schematic2, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 3/4, dev = "svg"}
plot_grid(
  p1,
  p2,
  NULL,
...
.center[
```{r sampling-schematic3, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 3/4, dev = "svg"}
plot_grid(
  p1,
  p2,
  p3,
...
.center[
```{r everest-highest-point, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
...
.center[
```{r everest_margins, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(margins)
...
.center[
```{r everest_margins2, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(ggdist)
...
.center[
```{r everest_margins3, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(ggdist)
...
.center[
```{r everest_margins4, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r everest_margins5, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r everest_margins6, echo = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.5, dev = "svg"}
library(ggdist)
library(distributional) # for dist_normal()
...
.center[
```{r gapminder-regressions, echo = FALSE, message = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.65, dev = "svg"}
gapminder %>%
  filter(
    continent != "Oceania",
...
.pull-left[
```{r gapminder-regressions2, echo = FALSE, message = FALSE, out.width = "95%", fig.width = 7, fig.asp = 0.65, dev = "svg"}
gapminder %>%
  filter(
    continent != "Oceania",
    year %in% c(1952, 1967, 1982, 1997)
...
.pull-right[
<br>
```{r gapminder-summary, echo = FALSE, message = FALSE, out.width = "95%", fig.width = 7, fig.asp = 0.5, dev = "svg"}
gapminder %>%
...
.pull-right[
```{r gapminder-model-out, ref.label = "gapminder-model", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.pull-right[
```{r gapminder-halfeye-out, ref.label = "gapminder-halfeye", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.pull-right[
```{r gapminder-gradinterval-out, ref.label = "gapminder-gradinterval", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.pull-right[
```{r gapminder-quantiledots-out, ref.label = "gapminder-quantiledots", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.pull-right[
```{r gapminder-quantiledots2-out, ref.label = "gapminder-quantiledots2", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
