...
.small-font[
Note: This pipeline automatically processes all species in the dataset
]
...
- `for` loops bring in data logistics (indexing)

--

- `for` loops cannot easily be parallelized or otherwise optimized

--

- most modern programming languages are moving away from `for` loops<br>
  (examples: Python, Rust, even JavaScript)
