...
.center[
```{r qual-scales-example1, ref.label = "qual-scales-example1", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example2, ref.label = "qual-scales-example2", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example3, ref.label = "qual-scales-example3", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example4, ref.label = "qual-scales-example4", echo = FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
