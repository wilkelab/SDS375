...
.center[
```{r temps-tiles1-out, ref.label = "temps-tiles1", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles2-out, ref.label = "temps-tiles2", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles3-out, ref.label = "temps-tiles3", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles4-out, ref.label = "temps-tiles4", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles5-out, ref.label = "temps-tiles5", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles6-out, ref.label = "temps-tiles6", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles7-out, ref.label = "temps-tiles7", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r temps-tiles8-out, ref.label = "temps-tiles8", echo = FALSE, out.width = "90%", fig.width = 7, fig.asp = .3, dev = "svg"}
```
]
...
.center[
```{r colorspace-palettes-seq-out, ref.label = 'colorspace-palettes-seq', echo = FALSE, out.width = "95%", fig.width = 12, fig.asp = .5, dev = "svg"}
```
]
]
...
.center[
```{r colorspace-palettes-div-out, ref.label = 'colorspace-palettes-div', echo = FALSE, out.width = "55%", fig.width = 6, fig.asp = 1, dev = "svg"}
```
]
]
...
.center[
```{r colorspace-palettes-divx-out, ref.label = 'colorspace-palettes-divx', echo = FALSE, out.width = "75%", fig.width = 8, fig.asp = .7, dev = "svg"}
```
]
]
...
.center[
```{r qual-scales-example1-out, ref.label = "qual-scales-example1", echo = FALSE, out.width = "55%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example2-out, ref.label = "qual-scales-example2", echo = FALSE, out.width = "55%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example3-out, ref.label = "qual-scales-example3", echo = FALSE, out.width = "55%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r qual-scales-example4-out, ref.label = "qual-scales-example4", echo = FALSE, out.width = "55%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
