...
.center[
```{r temp-normals-vs-time, echo=FALSE, message=FALSE, out.width = "70%", fig.width = 7, fig.asp = 0.618, dev="svg"}
...
.center[
```{r four-locations-temps-by-month, echo = FALSE, message = FALSE, out.width = "85%", fig.width = 8.5, fig.asp = .3, dev = "svg"}
...
.center.move-up-1em[
```{r mtcars-five-scale, echo = FALSE, message = FALSE, out.width = "60%", fig.width = 5.5, fig.asp = .8, dev = "svg"}
...
.center[
```{r ggplot-temps-example-out, ref.label="ggplot-temps-example", echo=FALSE, out.width = "55%", fig.width = 5.5, fig.asp = 0.618, dev="svg"}
```
]
...
.center[
```{r ggplot-temps-example2-out, ref.label="ggplot-temps-example2", echo=FALSE, out.width = "75%", fig.width = 5.5*6/4.2, fig.asp = .3, dev="svg"}
```
]
...
.center[
```{r ggplot-temps-example5-out, ref.label="ggplot-temps-example5", echo=FALSE, out.width = "55%", fig.width = 5.5, fig.asp = 0.618, dev="svg"}
```
]
...
.center[
```{r ggplot-temps-example6-out, ref.label="ggplot-temps-example6", echo=FALSE, out.width = "75%", fig.width = 5.5*6/4.2, fig.asp = .3, dev="svg"}
```
]
...
.center[
```{r ggplot-temps-example7-out, ref.label="ggplot-temps-example7", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
...
.center[
```{r ggplot-temps-example8-out, ref.label="ggplot-temps-example8", echo=FALSE, out.width = "90%", fig.width = 9, fig.asp = 0.44, dev="svg"}
```
]
...
.center[
```{r ggplot-color-fill-out, ref.label="ggplot-color-fill", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
...
.center[
```{r ggplot-color-fill2-out, ref.label="ggplot-color-fill2", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
...
.center[
```{r ggplot-color-fill3-out, ref.label="ggplot-color-fill3", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
...
.center[
```{r ggplot-color-fill-params-out, ref.label="ggplot-color-fill-params", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
...
.center[
```{r ggplot-color-fill-params2-out, ref.label="ggplot-color-fill-params2", echo=FALSE, out.width = "80%", fig.width = 8, fig.asp = 0.5, dev="svg"}
```
]
