...
.center[
```{r blue-jays-scatter, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
...
.center[
```{r blue-jays-scatter-lm, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  ggplot(aes(body_mass_g, head_length_mm)) + 
  geom_point(aes(fill = "blue jay birds"), pch = 21, color = "white", size = 2.5) +
...
.center[
```{r blue-jays-scatter-line-sex, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  ggplot(aes(body_mass_g, head_length_mm)) + 
...
.center[
```{r blue-jays-scatter-female, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  filter(sex == "F") %>%
...
.center[
```{r blue-jays-scatter-line-female, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  filter(sex == "F") %>%
  ggplot(aes(body_mass_g, head_length_mm, color = sex, fill = sex)) + 
  geom_point(pch = 21, color = "white", size = 2.5) +
...
.center[
```{r blue-jays-scatter-male, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  filter(sex == "M") %>%
  ggplot(aes(body_mass_g, head_length_mm, color = sex, fill = sex)) + 
  geom_point(pch = 21, color = "white", size = 2.5) +
...
.center[
```{r blue-jays-scatter-line-male, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  filter(sex == "M") %>%
  ggplot(aes(body_mass_g, head_length_mm, color = sex, fill = sex)) + 
  geom_point(pch = 21, color = "white", size = 2.5) +
...
.center[
```{r blue-jays-scatter-sex-line, echo = FALSE, message = FALSE, out.width = "55%", fig.width = 6, fig.asp = 3.2/4, dev = "svg"}
blue_jays %>%
  ggplot(aes(body_mass_g, head_length_mm, color = sex, fill = sex)) + 
  geom_point(pch = 21, color = "white", size = 2.5) +
  geom_smooth(method = "lm", linewidth = 0.75, se = FALSE, fullrange = TRUE) +
...
.center[
```{r biorxiv-nofit, echo = FALSE, out.width = "65%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r biorxiv-expfit, echo = FALSE, out.width = "65%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
biorxiv_growth <- preprints %>%
  filter(archive == "bioRxiv", count > 0)
...
.center[
```{r biorxiv-expfit-logscale, echo = FALSE, out.width = "65%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
biorxiv_growth <- preprints %>%
  filter(archive == "bioRxiv", count > 0)
...
.center[
```{r biorxiv-logscale, echo = FALSE, out.width = "65%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
ggplot(biorxiv_growth, aes(date_dec, count)) +
  geom_line(data = expfit.df, aes(color = "expfit"), linewidth = .5, linetype = 2) +
  geom_point(aes(fill = "expfit"), shape = NA, na.rm = TRUE) + # dummy for legend
...
.center[
```{r biorxiv-logscale-doublefit, echo = FALSE, warning = FALSE, out.width = "65%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
ggplot(biorxiv_growth, aes(date_dec, count)) +
  geom_line(data = expfit.df, aes(color = "expfit"), linewidth = .5, linetype = 2) +
  geom_point(aes(fill = "expfit"), shape = NA, na.rm = TRUE) + # dummy for legend
  geom_line(data = linfit.df, aes(color = "linfit"), linewidth = .5) +
...
```{r blue-jays-scatter-gg-out, ref.label = "blue-jays-scatter-gg", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r blue-jays-scatter-gg-smooth-out, ref.label = "blue-jays-scatter-gg-smooth", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r blue-jays-scatter-gg-lm-out, ref.label = "blue-jays-scatter-gg-lm", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r blue-jays-scatter-gg-lm-nose-out, ref.label = "blue-jays-scatter-gg-lm-nose", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r blue-jays-scatter-gg-sex-out, ref.label = "blue-jays-scatter-gg-sex", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-lm-out, ref.label = "cars-lm", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess-out, ref.label = "cars-loess", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess2-out, ref.label = "cars-loess2", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess3-out, ref.label = "cars-loess3", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess4-out, ref.label = "cars-loess4", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess5-out, ref.label = "cars-loess5", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-loess6-out, ref.label = "cars-loess6", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-gam-out, ref.label = "cars-gam", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-gam2-out, ref.label = "cars-gam2", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.xtiny-font.pull-right[
```{r cars-gam3-out, ref.label = "cars-gam3", echo = FALSE, out.width = "100%", fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
