...
.center.move-up-1em[
```{r boxoffice-vertical, echo = FALSE, fig.width = 10, fig.asp = .5, dev = "svg"}
boxoffice %>%
...
.center.move-up-1em[
```{r boxoffice-horizontal, echo = FALSE, fig.width = 9, fig.asp = .618, dev = "svg"}
...
.center[
```{r boxoffice-rot-axis-tick-labels, echo = FALSE, fig.width = 7, fig.asp = .85, dev = "svg"}
p_box_axrot <- 
...
.center.move-up-1em[
```{r boxoffice-horizontal-unordered, echo = FALSE, fig.width = 9, fig.asp = .618, dev = "svg"}
...
.center.move-up-1em[
```{r boxoffice-dotplot, echo = FALSE, fig.width = 9, fig.asp = .618, dev = "svg"}
ggplot(boxoffice, aes(x = fct_reorder(title, desc(rank)), y = amount)) +
...
.center.move-up-1em[
```{r Americas-life-expect, echo = FALSE, fig.width = 7., fig.asp = .9, dev = "svg"}
library(gapminder)
...
.center.move-up-1em[
```{r Americas-life-expect-bad1, echo = FALSE, fig.width = 7., fig.asp = .9, dev = "svg"}
...
.center.move-up-1em[
```{r Americas-life-expect-bad2, echo = FALSE, fig.width = 7., fig.asp = .9, dev = "svg"}
p <- ggplot(df_Americas, aes(x = lifeExp, y = fct_reorder(country, lifeExp))) +
  geom_col(fill = "#56B4E9", alpha = 0.9) +
  scale_x_continuous(
    name = "life expectancy (years)",
...
.center.move-up-1em[
```{r income-by-age-race-dodged, echo = FALSE, fig.width = 10, fig.asp = 0.5, dev = "svg"}
...
.center[
```{r income-by-race-age-dodged, echo = FALSE, fig.width = 10, fig.asp = 0.4, dev = "svg"}
...
.center[
```{r income-by-age-race-faceted, echo = FALSE, fig.width = 10, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r boxoffice-naive-out, ref.label = "boxoffice-naive", echo = FALSE, fig.width = 10, fig.asp = 0.4, dev = "svg"}
```
]
...
.center[
```{r boxoffice-ordered-out, ref.label = "boxoffice-ordered", echo = FALSE, fig.width = 10, fig.asp = 0.4, dev = "svg"}
```
]
...
.center[
```{r boxoffice-ordered2-out, ref.label = "boxoffice-ordered2", echo = FALSE, fig.width = 10, fig.asp = 0.4, dev = "svg"}
```
]
...
.center[
```{r boxoffice-ordered3-out, ref.label = "boxoffice-ordered3", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-bars-out, ref.label = "penguins-bars", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-bars2-out, ref.label = "penguins-bars2", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-bars3-out, ref.label = "penguins-bars3", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-sex-species-out, ref.label = "penguins-sex-species", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-sex-species2-out, ref.label = "penguins-sex-species2", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-sex-species-dodge-out, ref.label = "penguins-sex-species-dodge", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-sex-species-stack-out, ref.label = "penguins-sex-species-stack", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
...
.center[
```{r penguins-sex-species-fill-out, ref.label = "penguins-sex-species-fill", echo = FALSE, fig.width = 6.5, fig.asp = 0.618, dev = "svg"}
```
]
