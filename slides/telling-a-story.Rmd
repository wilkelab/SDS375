...
.center[
```{r preprints-part1, cache = params$cache, echo = FALSE, fig.width = 9, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r preprints-part2, cache = params$cache, echo = FALSE, fig.width = 9, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r arrival-delay-vs-distance, cache = params$cache, echo = FALSE, message = FALSE, fig.width = 9, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r mean-arrival-delay-nyc, cache = params$cache, echo = FALSE, message = FALSE, fig.width = 9, fig.asp = 0.618, dev = "svg"}
