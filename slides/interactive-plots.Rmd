...
```{r US_states_clickthrough, cache = params$cache, echo = FALSE}
...
```{r iris-no-girafe-demo-out, cache = params$cache, ref.label="iris-no-girafe-demo", echo=FALSE, warning=FALSE, fig.width = 6, fig.asp = 0.618, dev = "svg"}
```
]
...
.pull-right[
```{r iris-girafe-demo-out, cache = params$cache, ref.label="iris-girafe-demo", echo=FALSE, warning=FALSE}
```
]
...
.pull-right[
```{r iris-girafe-demo2-out, cache = params$cache, ref.label="iris-girafe-demo2", echo=FALSE, warning=FALSE}
```
]
...
.pull-right[
```{r iris-girafe-demo3-out, cache = params$cache, ref.label="iris-girafe-demo3", echo=FALSE, warning=FALSE}
```
]
...
.pull-right[
```{r iris-girafe-demo4-out, cache = params$cache, ref.label="iris-girafe-demo4", echo=FALSE, warning=FALSE}
```
...
.pull-right.width-50[
```{r US_states_clickthrough-demo-out, cache = params$cache, ref.label="US_states_clickthrough-demo", echo=FALSE, warning=FALSE}
```
]
