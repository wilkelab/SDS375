...
.center[
```{r iris-scatter-one-shape, cache = params$cache, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r iris-scatter-one-shape-cvd, cache = params$cache, echo = FALSE, out.width = "80%", fig.width = 9, fig.asp = 0.66, dev = "svg"}
...
.center[
```{r iris-scatter-three-shapes, cache = params$cache, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r iris-scatter-three-shapes-cvd, cache = params$cache, echo = FALSE, out.width = "80%", fig.width = 9, fig.asp = 0.66, dev = "svg"}
...
.center[
```{r tech-stocks-bad-legend, cache = params$cache, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
price_plot_base <- 
...
.center[
```{r tech-stocks-good-legend, cache = params$cache, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r tech-stocks-good-legend-cvd, cache = params$cache, echo = FALSE, out.width = "80%", fig.width = 9, fig.asp = 0.66, dev = "svg"}
price_plot_good_small <-
  price_plot_base_good + 
  geom_line(
    linewidth = .85*0.66, # make line size a little bigger than mathematically correct
    na.rm = TRUE
  ) +
  theme_minimal_hgrid(
    .655*14,
...
.center[
```{r tech-stocks-good-no-legend, cache = params$cache, echo = FALSE, out.width = "60%", fig.width = 7, fig.asp = 0.618, dev = "svg"}
...
.center[
```{r iris-scatter-with-ellipses, cache = params$cache, echo = FALSE, out.width = "45%", fig.width = 5.5, fig.asp = 0.8, dev = "svg"}
iris_labels <- tibble(
...
.center[
```{r texas-counties-log, cache = params$cache, echo = FALSE, message = FALSE, out.width = "70%", fig.width = 8, fig.asp = 0.6, dev = "svg"}
set.seed(3878)
...
.pull-right[
```{r tech-stock-sec-axis-out, cache = params$cache, ref.label="tech-stock-sec-axis", out.width = "100%", fig.width=5., fig.asp = 0.618, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right[
```{r tech-stock-sec-axis2-out, cache = params$cache, ref.label="tech-stock-sec-axis2", out.width = "100%", fig.width=5., fig.asp = 0.618, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right[
```{r iris-manual-out, cache = params$cache, ref.label="iris-manual", out.width = "100%", fig.width=5., fig.asp = 0.618, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right[
```{r iris-manual2-out, cache = params$cache, ref.label="iris-manual2", out.width = "100%", fig.width=5., fig.asp = 0.8, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right[
```{r iris-manual3-out, cache = params$cache, ref.label="iris-manual3", out.width = "100%", fig.width=5., fig.asp = 0.8, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot1-out, cache = params$cache, ref.label="mtcars-plot1", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot2-out, cache = params$cache, ref.label="mtcars-plot2", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot3-out, cache = params$cache, ref.label="mtcars-plot3", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot4-out, cache = params$cache, ref.label="mtcars-plot4", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot5-out, cache = params$cache, ref.label="mtcars-plot5", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot6-out, cache = params$cache, ref.label="mtcars-plot6", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
...
.pull-right.width-50[
```{r mtcars-plot7-out, cache = params$cache, ref.label="mtcars-plot7", out.width = "100%", fig.width=6., fig.asp = 0.75, echo=FALSE, warning=FALSE, dev = "svg"}
```
]
