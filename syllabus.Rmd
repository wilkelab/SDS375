...
14.     Working with models         `lm`, `cor.test`, broom package

15.     Visualizing uncertainty I   error bars, regression coefficient plots

16.     Visualizing uncertainty II  frequency framing, quantile dotplots

17.     Dimension reduction         PCA
...
**Note: This section was updated on 02/25/2021 due to the university closure from 02/14/2021 to 02/24/2021. The total number of homeworks was reduced from 10 to 9 and minimum guaranteed grades were adjusted accordingly.**
...
There will be nine homeworks and three projects. Both homeworks and projects need to be submitted electronically on Canvas. Homeworks are worth 10 points and projects are worth 100 points. The lowest-scoring homework will be dropped, so that a maximum of 80 points can be obtained from the homeworks.
...
Thus, in summary, each project contributes 23% to the final grade, the totality of all homeworks contributes another 18% to the final grade, and participation contributes 13%. **There are no traditional exams in this class and there is no final.**
