...
15.     Visualizing uncertainty     frequency framing, error bars, **ggdist** package

16.     Dimension reduction I       PCA

17.     Dimension reduction II      kernel PCA, t-SNE, UMAP

18.     Clustering                  k-means clustering
        
19.     Visualizing geospatial      `geom_sf()`, `coord_sf()`
        data

20.     Color spaces, color vision  **colorspace** package
        deficiency
        
21.     Redundant coding, text      **ggrepel** package
        annotations

22.     Interactive plots           **ggiraph** package

23.     Over-plotting               jittering, 2d histograms,
                                    contour plots
...
26.     Web technologies            HTML, CSS, **distill** package

27.     Animations                  **gganimate** package
----------------------------------------------------------------
:::
