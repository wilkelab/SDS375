...
The knitted R Markdown document (as a PDF) *and* the raw R Markdown file (as .Rmd) as well as any required data files should be submitted to Canvas by **11:00pm on April 9, 2021**. These two documents will be graded jointly, so they must be consistent (as in, don't change the R Markdown file without also updating the knitted document).
