...
We will be using the R package **tidyverse** for general data manipulation and visualization, the R package **sf** to handle simple features for geospatial plotting, the R package **glue** for text formatting, and the R package **ggiraph** for interactivity.
